...
class LTXVideoCausalDepthwiseSeperableConv3d(nn.Module):
    def __init__(
            self,
            in_channels: int,
            out_channels: int,
...
class LTXVideoResnetBlock3d(nn.Module):
    ...
    def __init__(
        ...
        self.conv_operation = LTXVideoCausalConv3d if not is_dw_conv else LTXVideoCausalDepthwiseSeperableConv3d
